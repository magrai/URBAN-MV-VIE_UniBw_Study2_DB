...
v_can_union."ESP_Querbeschleunigung"::NUMERIC * 9.81 AS acclat_ms2, 
v_can_union."ESP_Laengsbeschl"::NUMERIC AS acclon_ms2, 
...
v_can_union."KBI_Kilometerstand"::NUMERIC as mileage,
...
v_can_union."latitude"::NUMERIC AS gps_lat, 
--v_can_union."struct_1.latitude_deviation"::NUMERIC AS gps_lat_dev, 
v_can_union."longitude"::NUMERIC AS gps_lon

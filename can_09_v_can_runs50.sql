DROP VIEW IF EXISTS v_can_runs50 CASCADE;
CREATE OR REPLACE VIEW v_can_runs50 AS
...
WHERE
("public".v_can_wrange_gps_sx_helper_6final.runid = "public".v_condfinder.runs50_t1_runid OR
"public".v_can_wrange_gps_sx_helper_6final.runid = "public".v_condfinder.runs50_t2_runid) AND
